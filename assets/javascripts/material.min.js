$(document).ready(function() {
  $('table.list').addClass('mdl-data-table mdl-shadow--1dp');
  $('table.cal, .box').addClass('mdl-shadow--1dp');
  $('#content').addClass('mdl-shadow--2dp');
  $('table.list td, table.list th, table.cal td, table.cal th').addClass('mdl-data-table__cell--non-numeric');
})
